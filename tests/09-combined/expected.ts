...
async function airdropAndTransfer() {
  ...
  const ix = getTransferSolInstruction({ source: payer.address, destination: recipient, amount: LAMPORTS_PER_SOL });
